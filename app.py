...
primary_list = st.sidebar.selectbox("select primary parameter",  list_selection) 

plot1 = st.sidebar.button('Plot graph for primary parameter')
secondary_list = st.sidebar.selectbox("select secondary parameter",list_selection)
...
# uncomment for both parameters together
